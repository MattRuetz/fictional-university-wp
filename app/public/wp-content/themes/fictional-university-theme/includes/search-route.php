...
function universitySearchResults($data)
{
    $mainQuery = new WP_Query(array(
        ...
        's' => sanitize_text_field($data['term']), //search?term=[xxxx]
    ));
            ...
            if ($relatedCampuses) {
                foreach ($relatedCampuses as $campus) {
                    array_push($results['campuses'], array(
                        'title' => get_the_title($campus), // specify $campus because the_post currently is 'program'
    ...
    if ($results['programs']) {
        ...
        foreach ($results['programs'] as $item) {
            array_push($programsMetaQuery, array(
                ...
                'compare' => 'LIKE',
                'value' => '"' . $item['id'] . '"' // program id number
            ));
        }
