...
__webpack_require__.r(__webpack_exports__);
// FROM Advanced Custom Fields wp plugin docs
class GMap {
  constructor() {
...
class Search {
  ...
  events() {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).on('keydown', this.keyPressDispatcher.bind(this)); // Searching real-time event
