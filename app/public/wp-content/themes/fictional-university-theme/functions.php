...
{
    // Customize the REST API for this theme
    register_rest_field(
        'post',
        'authorName',
        array(
...
{
    $api['key'] = 'AIzaSyBSwi0eWese6VhQnw7m_C7tcEG3YTcLoyI';
...
//Redirect sub accounts to homepage (not admin)
function redirectSubsToFrontend()
{
    $ourCurrentUser = wp_get_current_user();

    // User has not write / edit ability ---> redirect out of admin
...
add_filter('wp_insert_post_data', 'makeNotePrivate', 10, 2); //10 = priority, 2= # parameters for callback
